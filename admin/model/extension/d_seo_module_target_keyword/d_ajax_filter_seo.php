...
class ModelExtensionDSEOModuleTargetKeywordDAjaxFilterSEO extends Model
{
    ...
    */
    public function getTargetElements()
    {
        ...
        $query = $this->db->query("SELECT q.query_id, tk.store_id, tk.language_id, tk.sort_order, tk.keyword FROM " . DB_PREFIX . "af_query q LEFT JOIN " . DB_PREFIX . "d_target_keyword tk ON (tk.route = CONCAT('af_query_id=', q.query_id))");
