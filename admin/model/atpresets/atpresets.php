...
class ModelAtpresetsAtpresets extends Model
{
    ...
    public function editPreset($preset_id, $data)
    {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "attribute_presets SET 1C_preset_id = '" . $this->db->escape($data['1C_preset_id']) . "', attribute_id = '" . (int)$data['attribute_id'] . "' WHERE preset_id = '" . $preset_id . "'");
