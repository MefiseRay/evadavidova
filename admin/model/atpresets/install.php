...
class ModelAtpresetsInstall extends Model {  
	...
	public function install($data=null) {
		...
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'catalog/atpresets');		
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'catalog/atpresets');
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'catalog/attemplate');			
		$this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'catalog/attemplate');		
		
		$this->load->model('extension/extension');
		$this->model_extension_extension->install('module', 'atpresets');			
	}
