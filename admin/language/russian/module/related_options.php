...
$_['entry_spec_ofs_help'] = 'указывать различные статусы \'Отсутствие на складе\' для комбинаций связанных опций (указанный для комбинации статус будет отображаться на странице товара, если покупатель выберет комбинацию связанных опций с нулевым остатком). Функция также должна быть включена для вывода остатка по выбранной комбинации опций на странице товара.';
