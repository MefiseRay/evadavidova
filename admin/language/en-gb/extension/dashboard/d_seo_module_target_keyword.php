<?php
// Heading
$_['heading_title'] = '<span style="color:#449DD0; font-weight:bold">SEO Module Target Keyword</span><span style="font-size:0.9em; color:#999"> by <a href="http://www.opencart.com/index.php?route=extension/extension&filter_username=Dreamvention" style="font-size:1em; color:#999" target="_blank">Dreamvention</a></span>';
$_['heading_title_main'] = 'SEO Module Target Keyword';
...
$_['text_heading_info'] = '(<span class="label label-danger">N</span> - number of <span class="text-danger"><strong>duplicate</strong></span>, <span class="label label-warning">N</span> - number of <strong>empty</strong>)';
$_['text_not_found'] = '
<div class="jumbotron">
