...
$_['entry_design_telephone_countries'] = 'Specify countries for telephone validation';
$_['entry_design_telephone_preferred_countries'] = 'Specify the countries to appear at the top of the list';
$_['entry_design_telephone_validation'] = 'Phone number validation';
...
$_['help_design_telephone_countries'] = 'Leave empty if you want all contries in the list. Add contry code separated with a comma if you want to list only specific contries for telephone validation (ex. us,gb,ca)';
$_['help_design_telephone_preferred_countries'] = 'Leave empty if you want list in alphabet order. Add country code separated with a comma if you want to list only specific top contries for telephone validation (ex. us,gb,ca)';
$_['help_design_telephone_validation'] = 'Turn on/off validation';
