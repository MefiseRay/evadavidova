...
$_['PHPExcelNotFound'] = 'Не обнаружен <a href="https://github.com/PHPOffice/PHPExcel" target="_blank">PHPExcel</a> (<a href="http://liveopencart.ru/phpexcel/" target="_blank">что такое PHPExcel?</a>). Отсутствует файл: ';
...
рекомендуется использовать если в шаблоне используется стантартный модуль галереи из OpenCart, включенных настройках модуля "' . $_['entry_img_use'] . '" и "' . $_['entry_img_limit'] . '"';
