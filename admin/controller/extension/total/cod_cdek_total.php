...
class ControllerExtensionTotalCodCdekTotal extends Controller
{
    private $error = array();
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/total/cod_cdek_total', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );

        $data['action'] = $this->url->link('extension/total/cod_cdek_total', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('extension/total/cod_cdek_total.tpl', $data));
    }
    ...
    private function validate()
    {
        ...
        if (!$this->user->hasPermission('modify', 'extension/total/cod_cdek_total')) {
