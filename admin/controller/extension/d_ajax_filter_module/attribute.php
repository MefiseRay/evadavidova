...
class ControllerExtensionDAjaxFilterModuleAttribute extends Controller
{
    ...
    public function prepare_template($setting)
    {
        ...
        $data['text_default_attribute_settings'] = $this->language->get('text_default_attribute_settings');
        ...
        $data['text_default_attribute_settings'] = $this->language->get('text_default_attribute_settings');
        $data['text_attribute_setting'] = $this->language->get('text_attribute_setting');
