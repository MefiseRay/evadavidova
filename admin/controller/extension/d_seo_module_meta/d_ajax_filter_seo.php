...
class ControllerExtensionDSEOModuleMetaDAjaxFilterSEO extends Controller
{
    private $codename = 'd_ajax_filter_seo';
    private $route = 'extension/d_seo_module_meta/d_ajax_filter_seo';
    ...
    */
    public function meta_generator_config($data)
    {
        ...
        $config_setting = ($_config->get($this->codename . '_meta_generator')) ? $_config->get($this->codename . '_meta_generator') : array();
