<?php 
class ControllerExtensionModulemasspcategupd extends Controller { 
	private $error = array();
	
	public function index() {

    		$this->load->language('extension/module/masspcategupd');

		$this->document->addStyle('view/template/extension/module/masspcategupd.css');
		...
		// Categories updates
		$data['masstxt_p_categories_updates'] = $this->language->get('masstxt_p_categories_updates');
		$data['masstxt_new_categories'] = $this->language->get('masstxt_new_categories');
		...
		if (isset($this->request->post['categ_ids_upd'])) {
			$data['categ_ids_upd'] = $this->request->post['categ_ids_upd'];
		} else {
			$data['categ_ids_upd'] = array();
		}
...
if ($this->user->hasPermission('modify', 'extension/module/masspcategupd')) { /// modify permision
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		if (isset($this->session->data['success'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/masspcategupd', 'token=' . $this->session->data['token'], true)
   		);
		...
		$data['action'] = $this->url->link('extension/module/masspcategupd', 'token=' . $this->session->data['token'], true);

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		
		$this->response->setOutput($this->load->view('extension/module/masspcategupd.tpl', $data));
	}
