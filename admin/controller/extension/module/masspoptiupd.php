                ...
                if (isset($this->request->post['selected'])) { /// avem produse selectate
                    ...
                    if ($this->request->post['opt_upd_mode'] == 'o_del' OR (isset($this->request->post['product_option']))) { /// avem options update
                        ...
                        if (isset($this->request->post['product_option'])) {
                            $data['product_option'] = $this->request->post['product_option'];
                        }
...
" . $plus_join . $plus_where;
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/masspoptiupd', 'token=' . $this->session->data['token'], true)
        );
        ...
        $data['action'] = $this->url->link('extension/module/masspoptiupd', 'token=' . $this->session->data['token'], true);

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');

        $this->response->setOutput($this->load->view('extension/module/masspoptiupd.tpl', $data));
    }
