<?php 
class ControllerExtensionModulemasspdwupd extends Controller { 
	private $error = array();
	
	public function index() {

    		$this->load->language('extension/module/masspdwupd');

		$this->document->addStyle('view/template/extension/module/masspdwupd.css');
		...
		$data['masstxt_p_updates_dimensions'] = $this->language->get('masstxt_p_updates_dimensions');
		$data['masstxt_p_updates_l'] = $this->language->get('masstxt_p_updates_l');
		$data['masstxt_p_updates_w'] = $this->language->get('masstxt_p_updates_w');
		$data['masstxt_p_updates_h'] = $this->language->get('masstxt_p_updates_h');
		$data['masstxt_p_updates_length_class'] = $this->language->get('masstxt_p_updates_length_class');
		$data['masstxt_p_updates_weight'] = $this->language->get('masstxt_p_updates_weight');
		$data['masstxt_p_updates_value'] = $this->language->get('masstxt_p_updates_value');
		$data['masstxt_p_updates_weight_class'] = $this->language->get('masstxt_p_updates_weight_class');
		...
		$data['masstxt_leave_empty_to_not_upd'] = $this->language->get('masstxt_leave_empty_to_not_upd');
		$data['masstxt_no_update_l_class_help'] = $this->language->get('masstxt_no_update_l_class_help');
		$data['masstxt_no_update_w_class_help'] = $this->language->get('masstxt_no_update_w_class_help');
		...
		$data['masstxt_mass_update_examples'] = $this->language->get('masstxt_mass_update_examples');
		...
		if (isset($this->request->post['filter_attr'])) {
    		...
    		if (isset($this->request->post['len_upd_mode'])) {
      			$data['len_upd_mode'] = $this->request->post['len_upd_mode'];
		} else {
      			$data['len_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['len_upd'])) {
      			$data['len_upd'] = $this->request->post['len_upd'];
		} else {
      			$data['len_upd'] = '';
    		}
    		

    		if (isset($this->request->post['wid_upd_mode'])) {
      			$data['wid_upd_mode'] = $this->request->post['wid_upd_mode'];
		} else {
      			$data['wid_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['wid_upd'])) {
      			$data['wid_upd'] = $this->request->post['wid_upd'];
		} else {
      			$data['wid_upd'] = '';
    		}


    		if (isset($this->request->post['hei_upd_mode'])) {
      			$data['hei_upd_mode'] = $this->request->post['hei_upd_mode'];
		} else {
      			$data['hei_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['hei_upd'])) {
      			$data['hei_upd'] = $this->request->post['hei_upd'];
		} else {
      			$data['hei_upd'] = '';
    		}

    		if (isset($this->request->post['weight_upd_mode'])) {
      			$data['weight_upd_mode'] = $this->request->post['weight_upd_mode'];
		} else {
      			$data['weight_upd_mode'] = 'ad';
    		}

		if (isset($this->request->post['weight_upd'])) {
      			$data['weight_upd'] = $this->request->post['weight_upd'];
		} else {
      			$data['weight_upd'] = '';
    		}

		if (isset($this->request->post['length_class_id_upd'])) {
      			$data['length_class_id_upd'] = $this->request->post['length_class_id_upd'];
		} else {
      			$data['length_class_id_upd'] = 'no-update';
    		}
    		
		if (isset($this->request->post['weight_class_id_upd'])) {
      			$data['weight_class_id_upd'] = $this->request->post['weight_class_id_upd'];
		} else {
      			$data['weight_class_id_upd'] = 'no-update';
    		}
...
if ($this->user->hasPermission('modify', 'extension/module/masspdwupd')) { /// modify permision

if (isset($this->request->post['selected'])) { /// avem produse selectate

if ($this->request->post['len_upd']!="" OR $this->request->post['wid_upd']!="" OR $this->request->post['hei_upd']!="" OR $this->request->post['weight_upd']!="" OR $this->request->post['length_class_id_upd']!="no-update" OR $this->request->post['weight_class_id_upd']!="no-update" OR $this->request->post['date_av_upd']!="" OR $this->request->post['status_upd']!="no-update") { /// avem update
...
if ($this->request->post['len_upd']!="") { /// avem length update
switch ($this->request->post['len_upd_mode']) {
    case "ad":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.length = (p.length + '".(float)$this->request->post['len_upd']."')";
        break;
    case "su":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.length = (p.length - '".(float)$this->request->post['len_upd']."')";
    ...
    case "re":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.length = '".(float)$this->request->post['len_upd']."'";
        break;
	}
}

if ($this->request->post['wid_upd']!="") { /// avem width update
switch ($this->request->post['wid_upd_mode']) {
    case "ad":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.width = (p.width + '".(float)$this->request->post['wid_upd']."')";
        break;
    case "su":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.width = (p.width - '".(float)$this->request->post['wid_upd']."')";
    ...
    case "re":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.width = '".(float)$this->request->post['wid_upd']."'";
        break;
	}
}

if ($this->request->post['hei_upd']!="") { /// avem height update
switch ($this->request->post['hei_upd_mode']) {
    case "ad":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.height = (p.height + '".(float)$this->request->post['hei_upd']."')";
        break;
    case "su":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.height = (p.height - '".(float)$this->request->post['hei_upd']."')";
    ...
    case "re":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.height = '".(float)$this->request->post['hei_upd']."'";
        break;
	}
}

if ($this->request->post['weight_upd']!="") { /// avem weight update
switch ($this->request->post['weight_upd_mode']) {
    case "ad":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.weight = (p.weight + '".(float)$this->request->post['weight_upd']."')";
        break;
    case "su":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.weight = (p.weight - '".(float)$this->request->post['weight_upd']."')";
    ...
    case "re":
        if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
        $plus_set.=$prfx."p.weight = '".(float)$this->request->post['weight_upd']."'";
        break;
	}
}

if ($this->request->post['length_class_id_upd']!="no-update") { /// avem length class update
    if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
    $plus_set.=$prfx."p.length_class_id = '".(int)$this->request->post['length_class_id_upd']."'";
}

if ($this->request->post['weight_class_id_upd']!="no-update") { /// avem weight class update
    if ($plus_set=="") { $prfx=" SET "; } else { $prfx=", "; }
    $plus_set.=$prfx."p.weight_class_id = '".(int)$this->request->post['weight_class_id_upd']."'";
}
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		if (isset($this->session->data['success'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/masspdwupd', 'token=' . $this->session->data['token'], true)
   		);
		...
		$data['action'] = $this->url->link('extension/module/masspdwupd', 'token=' . $this->session->data['token'], true);

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		
		$this->response->setOutput($this->load->view('extension/module/masspdwupd.tpl', $data));
	}
