...
class ControllerExtensionDAjaxFilterOption extends Controller
{
    ...
    public function index()
    {
        ...
        $this->document->addStyle('view/stylesheet/d_ajax_filter/option.css');
        ...
        $this->document->addScript('view/javascript/d_ajax_filter/option.js');
        ...
        $data['text_general_option_setting'] = $this->language->get('text_general_option_setting');
        ...
        $data['text_option_default_general'] = $this->language->get('text_option_default_general');
        ...
        if (!empty($data['setting']['options'])) {
            ...
            foreach ($data['setting']['options'] as $option_id => $value) {
                ...
                $data['setting']['options'][$option_id]['name'] = strip_tags(html_entity_decode($option_info['name'], ENT_QUOTES, 'UTF-8'));
            }
        }
