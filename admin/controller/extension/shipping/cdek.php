    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate() && !isset($this->error['warning'])) {
            ...
            if ($this->request->post['apply']) {
                $url = $this->url->link('extension/shipping/cdek', 'token=' . $this->session->data['token'], 'SSL');
            } else {
                $url = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=shipping', 'SSL');
            }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/shipping/cdek', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
        ...
        */
        ...
        $data['action'] = $this->url->link('extension/shipping/cdek', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('extension/shipping/cdek.tpl', $data));
    }
