...
class ControllerCommonFoldermanager extends Controller
{
    public function index()
    {
        ...
        foreach ($images as $image) {
            ...
            if (is_dir($image)) {
                ...
                $data['images'][] = array(
                    ...
                    'href' => $this->url->link('common/folder_manager', 'token=' . $this->session->data['token'] . '&directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE))) . $url, true)
                );
            }
        }
        ...
        $data['parent'] = $this->url->link('common/folder_manager', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $data['refresh'] = $this->url->link('common/folder_manager', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $pagination->limit = 16;
        $pagination->url = $this->url->link('common/folder_manager', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
