					...
					<table>
						<tr>
							<td>
								...
								$(<input type="text" name="<?php echo $_configurationName; ?>[content_selector_h1]" value="<?php echo ! empty( $_configurationValues['content_selector_h1'] ) ? $_configurationValues['content_selector_h1'] : '#content h1,#content h2'; ?>" />).first()
							</td>
							<td>
