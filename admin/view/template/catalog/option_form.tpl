            ...
            <tbody>
              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                <td class="text-left">
					...
					<input type="hidden" name="option_value[<?php echo $option_value_row; ?>][1C_option_value_id]" value="<?php echo $option_value['1C_option_value_id']; ?>" />
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
...
function addOptionValue() {
    ...
    html += '  <input type="hidden" name="option_value[' + option_value_row + '][1C_option_value_id]" value="" />';
	<?php foreach ($languages as $language) { ?>
