<div class="modal-dialog modal-lg" id="folder_manager">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo $heading_title; ?></h4><br>
      <div class="alert alert-warning">
      	<strong>Alert!</strong> <?php echo $alert_image_comparison_text; ?>
      </div>
    </div>
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 text-center">
          ...
          <label>
            <input type="radio" id="path" name="path" value="<?php echo $image['path']; ?>" />
...
$('#button-search').on('click', function(e) {
	var url = 'index.php?route=common/folder_manager&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: 'index.php?route=common/folder_manager/folder&token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: 'index.php?route=common/folder_manager/delete&token=<?php echo $token; ?>',
			type: 'post',
			dataType: 'json',
