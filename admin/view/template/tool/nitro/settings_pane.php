...
<div class="box-content">
    <table class="form settings">
        <tr>
            ...
            <td>
                <select name="Nitro[Enabled]" class="form-control NitroEnabled">
                    <option value="yes" <?php echo ((!empty($nitroData['Nitro']['Enabled']) && $nitroData['Nitro']['Enabled'] == 'yes')) ? 'selected=selected' : '' ?>>
                        Enabled
                    </option>
                    <option value="no" <?php echo ((empty($nitroData['Nitro']['Enabled']) || $nitroData['Nitro']['Enabled'] != 'yes')) ? 'selected=selected' : '' ?>>
                        Disabled
                    </option>
                </select>
            </td>
        ...
        <tr>
            <td>Recommended settings<span class="help">This will apply the most popular NitroPack configuration.</span>
            </td>
            <td><a class="btn btn-default" id="btn-recommended-settings"><i class="fa fa-magic"></i>&nbsp;&nbsp;Click to
                    apply the recommended settings</a></td>
        </tr>
        <tr>
            <td>Google PageSpeed API Key<span class="help"><strong>Important: </strong>We have inserted a default code to get you up and running. Please obtain your own Server API Key from <a
                            href="https://code.google.com/apis/console"
                            target="_blank"><u>Google API Console</u></a></span></td>
            <td>
                <input class="form-control" type="text" name="Nitro[GooglePageSpeedApiKey]" id="pagespeedApiKey"
                       value="<?php echo !empty($nitroData['Nitro']['GooglePageSpeedApiKey']) ? $nitroData['Nitro']['GooglePageSpeedApiKey'] : 'AIzaSyCxptR6CbHYrHkFfsO_XN3nkf6FjoQp2Mg'; ?>"/>
            </td>
        </tr>
        <tr>
            <td>System information<span class="help">Displays useful system information.</span></td>
            <td>
                <a class="btn btn-default system-info-refresh" data-toggle="modal" href="#infoModal"><i
                            class="icon-search"></i> Click to view system information</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-primary system-info-refresh"><i
                                            class="icon-white icon-refresh"></i> Refresh
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-default google-raw-refresh" data-toggle="modal" data-target="#infoGoogleRaw"><i
                            class="icon-search"></i> Click to view Google PageScore RAW result</a>
                <div id="infoGoogleRaw" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
        ...
        <tr>
            <td style="vertical-align:top;">Disable NitroPack for specific pages<span class="help">List the URLs (part or whole) of the pages, separated by newline. Wildcard * is available.</span>
            </td>
            <td>
                <textarea class="form-control" placeholder="e.g. ?route=product/product, each file on a new line"
                          style="width:400px; height:180px;"
                          name="Nitro[DisabledURLs]"><?php echo !empty($nitroData['Nitro']['DisabledURLs']) ? $nitroData['Nitro']['DisabledURLs'] : ''; ?></textarea>
            </td>
        </tr>
        <tr>
            <td>Serve jQuery from Google?<span class="help">If you enable this option, jQuery will be served from Google's hosted library. This will save one HTTP request to your server and may help deliver jQuery faster.</span>
            </td>
            <td>
                <select class="form-control" name="Nitro[GoogleJQuery]">
                    <option value="no" <?php echo ((!empty($nitroData['Nitro']['GoogleJQuery']) && $nitroData['Nitro']['GoogleJQuery'] == 'no')) ? 'selected=selected' : '' ?>>
                        Disabled
                    </option>
                    <option value="yes" <?php echo ((!empty($nitroData['Nitro']['GoogleJQuery']) && $nitroData['Nitro']['GoogleJQuery'] == 'yes')) ? 'selected=selected' : '' ?>>
                        Enabled
                    </option>
                </select>
            </td>
