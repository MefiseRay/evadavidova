        ...
        <td style="width:50%; vertical-align:top;padding-top:5px;">
            ...
            <table class="table stepsToTake">
                ...
                <tr class="<?php echo (!empty($nitroData['Nitro']['BrowserCache']['Enabled']) && $nitroData['Nitro']['BrowserCache']['Enabled'] == 'yes') ? 'disabled' : ''; ?>">
                    ...
                    <td>
                        <a onclick="$('html, body').animate({ scrollTop: 0 }, 200, function() { $('a[href=#browsercache]').trigger('click'); });"
                           class="btn btn-small btn-default">Setup Now</a></td>
                </tr>
                <tr class="<?php echo (!empty($nitroData['Nitro']['Compress']['Enabled']) && $nitroData['Nitro']['Compress']['Enabled'] == 'yes') ? 'disabled' : ''; ?>">
                    ...
                    <td>
                        <a onclick="$('html, body').animate({ scrollTop: 0 }, 200, function() { $('a[href=#compression]').trigger('click'); });"
                           class="btn btn-small btn-default">Setup Now</a></td>
                </tr>
                <tr class="<?php echo (!empty($nitroData['Nitro']['Mini']['CSS']) && $nitroData['Nitro']['Mini']['CSS'] == 'yes' && $nitroData['Nitro']['Mini']['JS'] == 'yes') ? 'disabled' : ''; ?>">
                    ...
                    <td>
                        <a onclick="$('html, body').animate({ scrollTop: 0 }, 200, function() { $('a[href=#minification]').trigger('click'); });"
                           class="btn btn-small btn-default">Setup Now</a></td>
                </tr>
...
<div class="text-greatscore hidden"><span class="label label-success">Great Score</span>&nbsp;&nbsp;<a
            href="http://www.seochat.com/c/a/search-engine-optimization-help/google-page-speed-score-vs-website-loading-time/"
            target="_blank">Top-ranking websites</a> in Google have an average score of 80.78 and yours is <strong
            id="greatscore-points"></strong>!
</div>
