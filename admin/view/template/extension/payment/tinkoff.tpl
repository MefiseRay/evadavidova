                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="tinkoff_enabled_taxation"><?php echo $tinkoff_enabled_taxation_label; ?></label>

                                <div class="col-sm-10">
                                    <input type="checkbox" name="tinkoff_enabled_taxation" onchange="showTinkoffTaxation(this.checked)" class="form-control" <?php echo ($tinkoff_enabled_taxation) ? 'checked' : '' ?> >
                                </div>
                            </div>

                            <div class="form-group">
                                <div <?php echo ($tinkoff_enabled_taxation) ? 'class="shown"' : 'class="hidden"' ?> id="tinkoffTaxation">
                                    <label class="col-sm-2 control-label" for="tinkoff_taxation"><?php echo $taxation_label; ?></label>
                                    <div class="col-sm-10">
                                        <select name="tinkoff_taxation" class="form-control">
                                            <?php foreach ($tinkoff_taxations as $code=>$taxation) { ?>
                                            <option value="<?=$code?>" <? if ($tinkoff_taxation == $code) { ?>selected="selected"<?}?>><?=$taxation?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
...
<script>
    function showTinkoffTaxation(checked) {
        var $tinkoffTaxation = $("#tinkoffTaxation");
        return checked ? $tinkoffTaxation.removeClass('hidden').addClass('shown') :  $tinkoffTaxation.removeClass('shown').addClass('hidden');
    }
</script>
<style>
    .hidden {
