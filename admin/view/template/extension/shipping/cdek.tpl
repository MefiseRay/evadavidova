		          			...
		          			<div class="form-group">
				                ...
				                <div class="col-sm-10">
				                	...
				                	<div class="input-group"> 
					                	<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
...
$('.cdek-tariff').on('change', function(event){
	...
	html += '<span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>';
