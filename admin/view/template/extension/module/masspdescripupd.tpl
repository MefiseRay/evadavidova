...
<div id="content">
  ...
  <div class="container-fluid"> <!-- continut -->
    ...
    <div class="panel panel-default"> <!-- updates div -->
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $masstxt_p_description_updates; ?></h3>
      </div>
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  <td class="text-left" style="width:411px;">
    	  <strong><?php echo $masstxt_find_description; ?></strong>
    	  <br />
    	  <span class="help"><?php echo $masstxt_find_description_help; ?></span>
    	  </td>
    	  <td class="text-left">
    	  <textarea name="description_find" class="fil_control3"><?php echo $description_find; ?></textarea>
    	  <br />
    	  </td>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  <td class="text-left" style="width:411px;">
    	  <strong><?php echo $masstxt_replace_description; ?></strong>
    	  <br />
    	  <span class="help"><?php echo $masstxt_replace_description_help; ?></span>
    	  </td>
    	  <td class="text-left">
    	  <textarea name="description_replace" class="fil_control3"><?php echo $description_replace; ?></textarea>
    	  <br />
    	  </td>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  <td class="text-left">
    	  <strong><?php echo $masstxt_upd_lang; ?></strong>
    	  </td>
    	  <td class="text-left">
    	    <select name="upd_lang" class="fil_control4">
    	    <option value="all"<?php if ($upd_lang=='all') { echo ' selected="selected"'; } ?>><?php echo $masstxt_all_languages; ?></option>
    	    <?php foreach ($languages as $language) { ?>
    	    <option value="<?php echo $language['language_id']; ?>"<?php if ($language['language_id']==$upd_lang) { echo ' selected="selected"'; } ?>><?php echo $language['name']; ?></option>
    	    <?php } ?>
    	    </select>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  ...
    	  <td class="radio1">
    	  <input type="radio"<?php if ($upd_mode=='firep') { echo ' checked="checked"'; } ?> value="firep" name="upd_mode" id="firep">
    	  <label for="firep"> <?php echo $masstxt_upd_mode_firep; ?></label>
    	  <br />
    	  <input type="radio"<?php if ($upd_mode=='adbeg') { echo ' checked="checked"'; } ?> value="adbeg" name="upd_mode" id="adbeg">
    	  <label for="adbeg"> <?php echo $masstxt_upd_mode_adbeg; ?></label>
    	  <br />
    	  <input type="radio"<?php if ($upd_mode=='adend') { echo ' checked="checked"'; } ?> value="adend" name="upd_mode" id="adend">
    	  <label for="adend"> <?php echo $masstxt_upd_mode_adend; ?></label>
    	  <br />
    	  <input type="radio"<?php if ($upd_mode=='delad') { echo ' checked="checked"'; } ?> value="delad" name="upd_mode" id="delad">
    	  <label for="delad"> <?php echo $masstxt_upd_mode_delad; ?></label>
    	  </td>
    	</tr>
