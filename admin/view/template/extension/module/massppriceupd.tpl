  ...
  <div class="container-fluid"> <!-- continut -->
    ...
    <div class="panel panel-default"> <!-- updates div -->
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  <td class="text-left" style="width:142px;">
    	  <strong><?php echo $masstxt_p_updates_price; ?></strong>
    	  </td>
    	  ...
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_price_addition_help; ?></span>
    	  <br />
    	  ...
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_price_subtraction_help; ?></span>
    	  <br />
    	  ...
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_price_multiplication_help; ?></span>
    	  <br />
    	  ...
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_price_replacement_help; ?></span>
    	  <br /><br />
    	  <?php echo $masstxt_p_updates_value; ?> <input size="10" type="text" value="<?php echo $price_val_upd; ?>" name="price_val_upd">
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_no_update_price_help; ?></span>
    	  </td>
    	</tr>

    	<tr>
    	  <td class="text-left">
    	  <strong><?php echo $masstxt_p_updates_tax_class; ?></strong>
    	  </td>
    	  <td class="text-left">
    	  <select name="tax_class_upd">
    	  <option value="no-update"<?php if ($tax_class_upd=='no-update') { echo ' selected="selected"'; } ?>><?php echo $masstxt_no_update; ?></option>
    	  <option value="0"<?php if ($tax_class_upd=='0') { echo ' selected="selected"'; } ?>> <?php echo $masstxt_none; ?> </option>
    	  <?php foreach ($tax_classes as $tax_class) { ?>
    	  <option value="<?php echo $tax_class['tax_class_id']; ?>"<?php if ($tax_class['tax_class_id']==$tax_class_upd) { echo ' selected="selected"'; } ?>><?php echo $tax_class['title']; ?></option>
    	  <?php } ?>
    	  </select>
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_no_update_tax_class_help; ?></span>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  ...
    	  <td class="text-left">
    	  <input class="date" size="14" type="text" value="<?php echo $date_av_upd; ?>" name="date_av_upd" data-date-format="YYYY-MM-DD">
