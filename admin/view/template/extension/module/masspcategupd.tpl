...
<div id="content">
  ...
  <div class="container-fluid"> <!-- continut -->
    ...
    <div class="panel panel-default"> <!-- updates div -->
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $masstxt_p_categories_updates; ?></h3>
      </div>
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  <td class="left" style="width:126px;">
    	  ...
    	  <td class="text-left">
    	  	<div class="well well-sm scroll1">
                  ...
                  <label>
                    ...
                    <input type="checkbox" name="categ_ids_upd[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                    <?php echo $category['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="categ_ids_upd[]" value="<?php echo $category['category_id']; ?>" />
                    <?php echo $category['name']; ?>
                    <?php } ?>
                  </label>
                  </div>
