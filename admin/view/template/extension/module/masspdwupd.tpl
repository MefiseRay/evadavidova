    ...
    <div class="panel panel-default"> <!-- updates div -->
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  ...
    	  <strong><?php echo $masstxt_p_updates_dimensions; ?></strong>
    	  </td>
    	  <td class="left">
    	  <div class="box_1">
    	  <strong><?php echo $masstxt_p_updates_l; ?></strong> <input size="10" type="text" value="<?php echo $len_upd; ?>" name="len_upd">
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_leave_empty_to_not_upd; ?>"></span></label>
    	  <br />
    	  <?php echo $masstxt_update_mode; ?> 
    	  <select name="len_upd_mode">
    	  <option value="ad"<?php if ($len_upd_mode=='ad') { echo ' selected="selected"'; } ?>><?php echo $masstxt_addition; ?></option>
    	  <option value="su"<?php if ($len_upd_mode=='su') { echo ' selected="selected"'; } ?>><?php echo $masstxt_subtraction; ?></option>
    	  <option value="mu"<?php if ($len_upd_mode=='mu') { echo ' selected="selected"'; } ?>><?php echo $masstxt_multiplication; ?></option>
    	  <option value="re"<?php if ($len_upd_mode=='re') { echo ' selected="selected"'; } ?>><?php echo $masstxt_replacement; ?></option>
    	  </select>
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_mass_update_examples; ?>"></span></label>
    	  </div>
    	  <div class="box_1">
    	  <strong><?php echo $masstxt_p_updates_w; ?></strong> <input size="10" type="text" value="<?php echo $wid_upd; ?>" name="wid_upd">
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_leave_empty_to_not_upd; ?>"></span></label>
    	  <br />
    	  <?php echo $masstxt_update_mode; ?> 
    	  <select name="wid_upd_mode">
    	  <option value="ad"<?php if ($wid_upd_mode=='ad') { echo ' selected="selected"'; } ?>><?php echo $masstxt_addition; ?></option>
    	  <option value="su"<?php if ($wid_upd_mode=='su') { echo ' selected="selected"'; } ?>><?php echo $masstxt_subtraction; ?></option>
    	  <option value="mu"<?php if ($wid_upd_mode=='mu') { echo ' selected="selected"'; } ?>><?php echo $masstxt_multiplication; ?></option>
    	  <option value="re"<?php if ($wid_upd_mode=='re') { echo ' selected="selected"'; } ?>><?php echo $masstxt_replacement; ?></option>
    	  </select>
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_mass_update_examples; ?>"></span></label>
    	  </div>
    	  <div class="box_2">
    	  <strong><?php echo $masstxt_p_updates_h; ?></strong> <input size="10" type="text" value="<?php echo $hei_upd; ?>" name="hei_upd">
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_leave_empty_to_not_upd; ?>"></span></label>
    	  <br />
    	  <?php echo $masstxt_update_mode; ?> 
    	  <select name="hei_upd_mode">
    	  <option value="ad"<?php if ($hei_upd_mode=='ad') { echo ' selected="selected"'; } ?>><?php echo $masstxt_addition; ?></option>
    	  <option value="su"<?php if ($hei_upd_mode=='su') { echo ' selected="selected"'; } ?>><?php echo $masstxt_subtraction; ?></option>
    	  <option value="mu"<?php if ($hei_upd_mode=='mu') { echo ' selected="selected"'; } ?>><?php echo $masstxt_multiplication; ?></option>
    	  <option value="re"<?php if ($hei_upd_mode=='re') { echo ' selected="selected"'; } ?>><?php echo $masstxt_replacement; ?></option>
    	  </select>
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_mass_update_examples; ?>"></span></label>
    	  </div>
    	  </td>
    	...
    	<tr>
    	  <td class="left">
    	  <strong><?php echo $masstxt_p_updates_length_class; ?></strong>
    	  </td>
    	  <td class="left">
    	  <select name="length_class_id_upd">
    	  <option value="no-update"<?php if ($length_class_id_upd=='no-update') { echo ' selected="selected"'; } ?>><?php echo $masstxt_no_update; ?></option>
    	  <?php foreach ($length_classes as $length_class) { ?>
    	  <option value="<?php echo $length_class['length_class_id']; ?>"<?php if ($length_class['length_class_id']==$length_class_id_upd) { echo ' selected="selected"'; } ?>><?php echo $length_class['title']; ?></option>
    	  <?php } ?>
    	  </select>
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_no_update_l_class_help; ?>"></span></label>
    	  </td>
    	</tr>

    	<tr>
    	  <td class="left">
    	  <strong><?php echo $masstxt_p_updates_weight; ?></strong>
    	  </td>
    	  <td class="left">
    	  <div class="box_2">
    	  <?php echo $masstxt_p_updates_value; ?> <input size="10" type="text" value="<?php echo $weight_upd; ?>" name="weight_upd">
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_leave_empty_to_not_upd; ?>"></span></label>
    	  <br />
    	  <?php echo $masstxt_update_mode; ?> 
    	  <select name="weight_upd_mode">
    	  <option value="ad"<?php if ($weight_upd_mode=='ad') { echo ' selected="selected"'; } ?>><?php echo $masstxt_addition; ?></option>
    	  <option value="su"<?php if ($weight_upd_mode=='su') { echo ' selected="selected"'; } ?>><?php echo $masstxt_subtraction; ?></option>
    	  <option value="mu"<?php if ($weight_upd_mode=='mu') { echo ' selected="selected"'; } ?>><?php echo $masstxt_multiplication; ?></option>
    	  <option value="re"<?php if ($weight_upd_mode=='re') { echo ' selected="selected"'; } ?>><?php echo $masstxt_replacement; ?></option>
    	  </select>
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_mass_update_examples; ?>"></span></label>
    	  </div>
    	  </td>
    	...
    	<tr>
    	  <td class="left">
    	  <strong><?php echo $masstxt_p_updates_weight_class; ?></strong>
    	  </td>
    	  <td class="left">
    	  <select name="weight_class_id_upd">
    	  <option value="no-update"<?php if ($weight_class_id_upd=='no-update') { echo ' selected="selected"'; } ?>><?php echo $masstxt_no_update; ?></option>
    	  <?php foreach ($weight_classes as $weight_class) { ?>
    	  <option value="<?php echo $weight_class['weight_class_id']; ?>"<?php if ($weight_class['weight_class_id']==$weight_class_id_upd) { echo ' selected="selected"'; } ?>><?php echo $weight_class['title']; ?></option>
    	  <?php } ?>
    	  </select>
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_no_update_w_class_help; ?>"></span></label>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  ...
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_no_update_date_a_help; ?>"></span></label>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  ...
    	  <label class="control-label"><span data-toggle="tooltip" title="<?php echo $masstxt_no_update_status_help; ?>"></span></label>
    	  </td>
    	</tr>
