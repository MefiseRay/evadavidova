...
<div id="content">
  ...
  <div class="container-fluid"> <!-- continut -->
    ...
    <div class="panel panel-default"> <!-- updates div -->
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $masstxt_p_stores_updates; ?></h3>
      </div>
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  ...
    	  <strong><?php echo $masstxt_new_stores; ?></strong>
    	  </td>
    	  <td class="text-left">
    	  <div class="well well-sm scroll1">
                  <div class="checkbox">
                  <label>
                    <?php if (in_array(0, $stores_ids_upd)) { ?>
                    <input type="checkbox" name="stores_ids_upd[]" value="0" checked="checked" />
                    <?php echo $masstxt_default; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="stores_ids_upd[]" value="0" />
                    <?php echo $masstxt_default; ?>
                    <?php } ?>
                  </label>
                  </div>
                  ...
                  <div class="checkbox">
                  <label>
                    <?php if (in_array($store['store_id'], $stores_ids_upd)) { ?>
                    <input type="checkbox" name="stores_ids_upd[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                    <?php echo $store['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="stores_ids_upd[]" value="<?php echo $store['store_id']; ?>" />
                    <?php echo $store['name']; ?>
                    <?php } ?>
                  </label>
                  </div>
