...
<div id="content">
  ...
  <div class="container-fluid"> <!-- continut -->
    ...
    <div class="panel panel-default"> <!-- updates div -->
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $masstxt_p_attributes_updates; ?></h3>
      </div>
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  ...
    	  <div class="for_autocomplete"><?php echo $masstxt_load_existing_attributes; ?></div>
                  ...
                  <tbody>
                    ...
                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                      ...
                      <td class="text-left"><?php foreach ($languages as $language) { ?>
                        <div class="input-group"><span class="input-group-addon"><img src="<?php if (version_compare(VERSION, '2.2.0.0', '>=')) { echo 'language/'.$language['code'].'/'.$language['code'].'.png'; } else { echo 'view/image/flags/'.$language['image']; } ?>" title="<?php echo $language['name']; ?>" /></span>
    	...
    	<tr>
    	  ...
    	  <br />
    	  <input type="radio"<?php if ($upd_mode=='de_a_v') { echo ' checked="checked"'; } ?> value="de_a_v" name="upd_mode" id="rg7">
    	  <label for="rg7"> <?php echo $masstxt_upd_mode_de_a_v; ?></label>
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_mode_de_a_v_help; ?></span>
    	  <br />
    	  <input type="radio"<?php if ($upd_mode=='de_a') { echo ' checked="checked"'; } ?> value="de_a" name="upd_mode" id="rg8">
    	  <label for="rg8"> <?php echo $masstxt_upd_mode_de_a; ?></label>
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_mode_de_a_help; ?></span>
    	  <br />
    	  ...
    	  <br />
    	  <input type="radio"<?php if ($upd_mode=='de_val') { echo ' checked="checked"'; } ?> value="de_val" name="upd_mode" id="rg6">
    	  <label for="rg6"> <?php echo $masstxt_upd_mode_de_val; ?></label>
    	  <span style="color:#666666;font-size:11px;">&nbsp; <?php echo $masstxt_upd_mode_de_val_help; ?></span>
    	  </td>
    	</tr>
...
function addAttribute() {
	...
	html += '<div class="input-group"><span class="input-group-addon"><img src="<?php if (version_compare(VERSION, '2.2.0.0', '>=')) { echo 'language/'.$language['code'].'/'.$language['code'].'.png'; } else { echo 'view/image/flags/'.$language['image']; } ?>" title="<?php echo $language['name']; ?>" /></span><textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
    <?php } ?>
	html += '  </td>';
...
$('input[name=\'filter_namex\']').autocomplete({
	...
	'select': function(item) {
		...
		$('input[name=\'product_id_to_attr\']').val(item['value']);
