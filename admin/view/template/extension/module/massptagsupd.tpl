    ...
    <div class="panel panel-default"> <!-- updates div -->
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  ...
    	  <img src="<?php if (version_compare(VERSION, '2.2.0.0', '>=')) { echo 'language/'.$language['code'].'/'.$language['code'].'.png'; } else { echo 'view/image/flags/'.$language['image']; } ?>" title="<?php echo $language['name']; ?>" style="vertical-align: middle;" /><br />
    	  <?php } ?></td>
