    ...
    <div class="panel panel-default"> <!-- updates div -->
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  ...
    	  <strong><?php echo $masstxt_new_manufacturer; ?></strong>
    	  </td>
    	  <td class="text-left">
    	  <select name="manufacturer_id_upd">
    	  <option value="0"<?php if ($manufacturer_id_upd==0) { echo ' selected="selected"'; } ?>><?php echo $masstxt_none; ?></option>
    	  <?php foreach ($manufacturers as $manufacturer) { ?>
    	  <option value="<?php echo $manufacturer['manufacturer_id']; ?>"<?php if ($manufacturer['manufacturer_id']==$manufacturer_id_upd) { echo ' selected="selected"'; } ?>><?php echo $manufacturer['name']; ?></option>
    	  <?php } ?>
    	  </select>
    	  </td>
    	</tr>
