...
<div id="content">
  ...
  <div class="container-fluid"> <!-- continut -->
    ...
    <div class="panel panel-default"> <!-- updates div -->
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $masstxt_p_name_updates; ?></h3>
      </div>
      ...
      <div class="table-responsive">
    	...
    	<tr>
    	  <td class="text-left" style="width:333px;">
    	  <strong><?php echo $masstxt_find_name; ?></strong>
    	  <br />
    	  <span class="help"><?php echo $masstxt_find_name_help; ?></span>
    	  </td>
    	  <td class="text-left">
    	  <input name="name_find" size="64" value="<?php echo $name_find; ?>" />
    	  <br />
    	  </td>
    	  </td>
    	</tr>
    	...
    	<tr>
    	  <td class="text-left">
    	  <strong><?php echo $masstxt_replace_name; ?></strong>
    	  <br />
    	  <span class="help"><?php echo $masstxt_replace_name_help; ?></span>
    	  </td>
    	  <td class="text-left">
    	  <input name="name_replace" size="64" value="<?php echo $name_replace; ?>" />
    	  <br />
    	  </td>
    	  </td>
    	</tr>
