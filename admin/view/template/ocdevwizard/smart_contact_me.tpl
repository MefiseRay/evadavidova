          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="layout-block">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-success <?php echo $form_data['show_on_dashboard'] == 1 ? 'active' : ''; ?>">
                      <input type="radio" 
                        name="<?php echo $_module_name; ?>_form_data[show_on_dashboard]" 
                        value="1" 
                        autocomplete="off" 
                        <?php echo $form_data['show_on_dashboard'] == 1 ? 'checked="checked"' : ''; ?> 
                      /><?php echo $text_yes; ?>
                    </label>
                    <label class="btn btn-success <?php echo $form_data['show_on_dashboard'] == 0 ? 'active' : ''; ?>">
                      <input type="radio" 
                        name="<?php echo $_module_name; ?>_form_data[show_on_dashboard]" 
                        value="0" 
                        autocomplete="off" 
            ...
            <div class="tab-pane" id="support-general-block">
              <?php echo (isset($support_info['general'])) ? $support_info['general'] : '<div class="alert alert-danger" role="alert"><i class="fa fa-info-circle" aria-hidden="true"></i> '.$error_xml_load_error.'</div>'; ?>
            </div>
            ...
            <div class="tab-pane" id="support-extension-block">
              <div class="panel panel-default">
                ...
                <table class="table">
                  ...
                  <?php if ($product['extension_id'] == 22031) { ?>
                  <tr>
            ...
            <div class="tab-pane" id="support-terms-block">
              <?php echo (isset($support_info['terms'])) ? $support_info['terms'] : '<div class="alert alert-danger" role="alert"><i class="fa fa-info-circle" aria-hidden="true"></i> '.$error_xml_load_error.'</div>'; ?>
            </div>
            <!-- TAB Support Faq block -->
            <div class="tab-pane" id="support-faq-block">
              <?php echo (isset($support_info['faq'])) ? $support_info['faq'] : '<div class="alert alert-danger" role="alert"><i class="fa fa-info-circle" aria-hidden="true"></i> '.$error_xml_load_error.'</div>'; ?>
            </div>
            <!-- TAB Support Service block -->
            <div class="tab-pane" id="support-service-block">
              <?php echo (isset($support_info['service'])) ? $support_info['service'] : '<div class="alert alert-danger" role="alert"><i class="fa fa-info-circle" aria-hidden="true"></i> '.$error_xml_load_error.'</div>'; ?>
            </div>
            <!-- TAB OCdev Products --> 
