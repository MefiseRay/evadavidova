...
if (!defined('NITRO_BASE_CSS_FOLDER')) define('NITRO_BASE_CSS_FOLDER', DIR_SYSTEM . 'nitro' . DS . 'cache' . DS . 'base_css' . DS);
if (!defined('NITRO_PERSISTENCE_FOLDER')) define('NITRO_PERSISTENCE_FOLDER', DIR_SYSTEM . 'nitro' . DS . 'data' . DS);
