...
class Speedup
{
    ...
    {
        include_once DIR_SYSTEM . '/library/minify/CSSMin.php';
        $result = Minify_CSS_Compressor::process($input);
        return $result;
    }

    public function minify_js($input, $comment = 2, $quote = 2)
    {
        include_once DIR_SYSTEM . '/library/minify/JSMin.php';
        $jz = new JSqueeze();
