...
const ERROR_INVALID_NAME = 'errInvName';
    ...
    const ERROR_COPY = 'errCopy';
        const ERROR_MOVE = 'errMove';     // 'File not found.'
        const ERROR_COPY_FROM = 'errCopyFrom'; // 'Target folder "$1" not found.'
    const ERROR_COPY_TO = 'errCopyTo';
    const ERROR_COPY_ITSELF = 'errCopyInItself';
const ERROR_REPLACE = 'errReplace';
    const ERROR_RM = 'errRm';        // '"$1" is locked and can not be renamed, moved or removed.'
    const ERROR_RM_SRC = 'errRmSrc';        // 'File named "$1" already exists.'
    const ERROR_UPLOAD = 'errUpload';       // 'Invalid file name.'
...
const ERROR_NOT_REPLACE = 'errNotReplace';
    const ERROR_SAVE = 'errSave';
        const ERROR_EXTRACT = 'errExtract';          // 'Unable to replace "$1".'
        const ERROR_ARCHIVE = 'errArchive';               // 'Unable to remove "$1".'
        const ERROR_NOT_ARCHIVE = 'errNoArchive';            // 'Unable remove source file(s)'
        const ERROR_ARCHIVE_TYPE = 'errArcType';           // 'Upload error.'
        const ERROR_ARC_SYMLINKS = 'errArcSymlinks';       // 'Unable to upload "$1".'
        const ERROR_ARC_MAXSIZE = 'errArcMaxSize';    // 'No files found for upload.'
        const ERROR_RESIZE = 'errResize';  // 'Data exceeds the maximum allowed size.'
        const ERROR_UNSUPPORT_TYPE = 'errUsupportType';   // 'File exceeds maximum allowed size.'
        const ERROR_NOT_UTF8_CONTENT = 'errNotUTF8Content';       // 'File type not allowed.'
        const ERROR_NETMOUNT = 'errNetMount';   // '"$1" transfer error.'
    // const ERROR_ACCESS_DENIED     = 'errAccess';
        const ERROR_NETMOUNT_NO_DRIVER = 'errNetMountNoDriver';       // Object "$1" already exists at this location and can not be replaced with object of another type.
