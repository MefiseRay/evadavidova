<div id="smcm-modal-body">
  ...
  <div class="modal-footer">
    <input type="button" onclick="$.magnificPopup.close();" value="<?php echo $button_close; ?>" class="close_button_bottom" />
    <input type="button" onclick="sendFeedbackPopup('<?php echo $form_id ?>');" value="<?php echo $button_send_order; ?>" class="send-button-data" />
  </div>
  <script type="text/javascript">
    $('.mfp-bg').css({
