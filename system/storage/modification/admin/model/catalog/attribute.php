					...
					foreach ($data['presets'] as $preset) {
						...
						if ($preset['preset_id']!=0) 
							if (isset($preset['text'])) 
								$this->model_atpresets_atpresets->editPreset($preset['preset_id'],$preset);	
							else
								$this->model_atpresets_atpresets->deletePreset($preset['preset_id']);	
						else if (isset($preset['text'])) 
							$this->model_atpresets_atpresets->addPreset($preset);
					}
				}
			}
