...
// CDEK OCMOD START
      ...
      $cdek_other[] = array(
        'name'     => 'Поддержка',
        'href'     => 'http://services.opencart.ru/ticket/',
        'children' => array()   
      );
      $cdek_other[] = array(
        'name'     => 'Лицензия',
      ...
      // CDEK OCMOD END
			...
			if ($this->config->get('atpresets_installed')==1) {
				...
				if ($this->user->hasPermission('access', 'catalog/attemplate')) {
					$attribute[] = array(
						'name'	   => $this->language->get('text_attemplate'),
						'href'     => $this->url->link('catalog/attemplate', 'token=' . $this->session->data['token'], true),
						'children' => array()		
					);
				}	
			}			
			...
			if ($this->user->hasPermission('access', 'catalog/manufacturer')) {
				...
				$coc[] = array(
					...
					'href'     => $this->url->link('coc/all', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_bestseller'),
					'href'     => $this->url->link('coc/bestseller', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_special'),
					'href'     => $this->url->link('coc/special', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_discount'),
					'href'     => $this->url->link('coc/discount', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_featured'),
					'href'     => $this->url->link('coc/featured', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_latest'),
					'href'     => $this->url->link('coc/latest', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_mostviewed'),
					'href'     => $this->url->link('coc/mostviewed', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
				$coc[] = array(
					'name'	   => $this->language->get('text_customized'),
					'href'     => $this->url->link('coc/customized', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);

				if ($coc) {
				  $catalog[] = array(
					  'name'	   => $this->language->get('text_more_page'),
					  'href'     => '',
					  'children' => $coc
				  );
			 	}
			...
			if ($this->user->hasPermission('access', 'catalog/information')) {		
				...
				if ($this->user->hasPermission('access', 'catalog/contact')) {		
					$catalog[] = array(
						'name'	   => $this->language->get('text_contact_page'),
						'href'     => $this->url->link('catalog/contact', 'token=' . $this->session->data['token'], true),
						'children' => array()		
					);					
				}
        ...
        $smcm[] = array(
          'name'     => $this->language->get('text_smart_contact_me_setting_left_menu'),
          'href'     => $this->url->link('ocdevwizard/smart_contact_me', 'token=' . $this->session->data['token'], true),
          'children' => array()
        );    

        $smcm[] = array(
          'name'     => $this->language->get('text_smart_contact_me_form_left_menu'),
          'href'     => $this->url->link('ocdevwizard/smart_contact_me_form', 'token=' . $this->session->data['token'], true),
          'children' => array()
        );   

        $smcm[] = array(
          'name'     => $this->language->get('text_smart_contact_me_message_left_menu'),
          'href'     => $this->url->link('ocdevwizard/smart_contact_me_message', 'token=' . $this->session->data['token'], true),
          'children' => array()
        );   

        $ocdevwizard[] = array(
          'name'     => $this->language->get('text_smart_contact_me_left_menu'),
          'href'     => '',
          'children' => $smcm
        );
        ...
        // end: OCdevWizard
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'tool/backup')) {
				...
				if ($this->user->hasPermission('access', 'tool/robots')) {
					$tool[] = array(
