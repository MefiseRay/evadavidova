...
class ModelExportYandexMarket extends Model {
	...
	public function getProductImages($product_id) {
		$query = $this->db->query("SELECT image FROM " . DB_PREFIX . "product_image WHERE product_id='" . $product_id . "' LIMIT 9");
