...
class ModelMenuMegamenu extends Model
{
    ...
    public function getCategories($array = array())
    {
        ...
        if (!($array['columns'] > 0 && $array['columns'] < 7)) {
            $array['columns'] = 1;
        }
                        ...
                        if (is_array($info_category) || isset($array['categories'][$i]['type'])) {
                                    ...
                                    if (isset($info_link['url'])) {
                                        ...
                                        if (isset($name_array[$lang_id])) {
                                            if (!empty($name_array[$lang_id])) {
                                                ...
                                                if ($label_array[$lang_id] != '') {
                                                    $info_category['name'] .= '<span class="megamenu-label" style="background: ' . $info_link['label_background'] . ';color: ' . $info_link['label_text'] . '"><span style="background: ' . $info_link['label_background'] . ';border-color: ' . $info_link['label_background'] . '"></span>' . $label_array[$lang_id] . '</span>';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if (isset($info_category['name'])) {
                                ...
                                if ($array['submenu'] == 2 && $array['image_position'] == 2 && $image_url) {
                                    ...
                                    $output .= '<div class="categories-image-top"><a href="' . $link . '"><img src="' . $image . '" alt="Image"></a></div>';
                                }
