    ...
    public function index()
    {
        ...
        */
        ...
        if (isset($this->request->get['remove'])) {
            ...
            $this->session->data['wishlist'] = array_diff($this->session->data['wishlist'], [$this->request->get['remove']]);
    ...
    public function remove()
    {
        ...
        if ($product_info) {
            if ($this->customer->isLogged()) {
                ...
                $this->session->data['wishlist'] = array_diff($this->session->data['wishlist'], array($this->request->post['product_id']));
