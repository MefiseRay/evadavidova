...
class ControllerProductFeatured extends Controller { 	
	...
	public function index() { 
		...
		$this->language->load('product/featured');
		
		if((int)$this->config->get('coc_featured_status') == 1) {
			...
			$coc_featured_description = $this->config->get('coc_featured_description');
	
			$this->document->setTitle($coc_featured_description[(int)$this->config->get('config_language_id')]['meta_title']);
			
			$this->document->setDescription($coc_featured_description[(int)$this->config->get('config_language_id')]['meta_description']);
			
			$this->document->setKeywords($coc_featured_description[(int)$this->config->get('config_language_id')]['meta_keyword']);
			
			$this->document->addLink($this->url->link('product/featured', ''), 'canonical');
			...
			$data['breadcrumbs'][] = array(
				...
				'text' => $coc_featured_description[(int)$this->config->get('config_language_id')]['heading_title'],
				
				'href' => $this->url->link('product/featured', $url)
				
			);
	
			$data['heading_title'] = $coc_featured_description[(int)$this->config->get('config_language_id')]['heading_title'];
			...
			$this->load->model('coc/featured');
			
			$results = $this->model_coc_featured->getFeaturedProducts();
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/featured', 'sort=p.sort_order&order=ASC' . $url)
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/featured', 'sort=pd.name&order=ASC' . $url)
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/featured', 'sort=pd.name&order=DESC' . $url)
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/featured', 'sort=p.price&order=ASC' . $url)
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/featured', 'sort=p.price&order=DESC' . $url)
			...
			if ($this->config->get('config_review_status')) {	
				...
				$data['sorts'][] = array(
					...
					'href'  => $this->url->link('product/featured', 'sort=rating&order=DESC' . $url)
				...
				$data['sorts'][] = array(
					...
					'href'  => $this->url->link('product/featured', 'sort=rating&order=ASC' . $url)
			...
			$data['sorts'][] = array(
					...
					'href'  => $this->url->link('product/featured', 'sort=p.model&order=ASC' . $url)
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/featured', 'sort=p.model&order=DESC' . $url)
			...
			foreach($limits as $value){
				...
				$data['limits'][] = array(
					...
					'href'  => $this->url->link('product/featured', $url . '&limit=' . $value)
			...
			$pagination->url = $this->url->link('product/featured', $url . '&page={page}');
