      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
              <span onclick="$(this).next().val($(this).next().val()-1);$(this).parents('form').submit();" class="btn-quantity">&minus;</span>
              <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="2" />
              <span onclick="$(this).prev().val(~~$(this).prev().val()+1);$(this).parents('form').submit();" class="btn-quantity">+</span>         
          </td>
          <td class="text-right hidden-xs"><?php echo $product['price']; ?></td>
          <td class="text-right"><?php echo $product['total']; ?></td>
          <td class="text-right">
               <a class="btn-close" onclick="cart.remove('<?php echo $product['cart_id']; ?>');">x</a>
          </td>
        </tr>
        <?php } ?>
