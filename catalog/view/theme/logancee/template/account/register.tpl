...
include('catalog/view/theme/' . $config->get($config->get('config_theme') . '_directory') . '/template/new_elements/wrapper_top.tpl'); ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <label class="radio-inline">
                ...
                <span><?php echo $text_yes; ?></span></label>
              <label class="radio-inline">
                <input type="radio" name="newsletter" value="0" />
                <span><?php echo $text_no; ?></span></label>
              <?php } else { ?>
              <label class="radio-inline">
        ...
        <?php echo $captcha; ?>
        <?php if ($text_agree) { ?>
        <div class="personal-data text-right">
            <?php if ($agree) { ?>
            <input id="agreament-register" type="checkbox" name="agree" value="1" checked="checked" />
            <?php } else { ?>
            <input id="agreament-register" type="checkbox" name="agree" value="1" />
            <?php } ?>
            <label for="agreament-register"> <?php echo $text_agree; ?></label>
        </div>
        <div class="buttons">
