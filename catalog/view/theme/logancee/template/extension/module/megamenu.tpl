		...
		<div class="megamenuToogle-wrapper">
			<div class="megamenuToogle-pattern">
				<div class="container">
					...
					<span><?php echo $navigation_text; ?></span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="megamenu-pattern">
			<div class="container">
				<ul class="megamenu <?php if($ustawienia['animation'] != '') { echo $ustawienia['animation']; } ?>">
					...
					<li class="home"><a href="<?php echo $home; ?>"><?php if($ustawienia['home_item'] == 'icon') { ?><i class="fa fa-home"></i><?php } else { echo '<span>'.$home_text.'</span>'; } ?></a></li>
					<?php } ?>
					<?php
						foreach($menu as $row) {
							$class = '';
							...
							echo "<a href='".$row['link']."' class='".$class_link."' ".$target."><span>".$row['icon'].html_entity_decode($row['name'][$lang_id]).html_entity_decode($row['description']).$label."</span></a>";
						...
						<div class="search_form">
				            <div class="quick-search">
                                <div class="form-search">
                                    <span class="button-search2"><i class="icon-magnifier"></i></span>
                                    <input type="text" class="input-block-level search-query" name="search" placeholder="" id="search_query2" value="<?php echo $search; ?>" />
