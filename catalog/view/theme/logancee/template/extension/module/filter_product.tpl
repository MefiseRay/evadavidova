...
<div class="filter-product">
	...
	<div class="tab-content clearfix">
		...
		<div class="tab-pane <?php if($s == 0) { echo 'active'; } ?>" id="<?php echo $tab['title'].'-'.$id.'-'.$s; ?>">
			<?php if($carousel != 0) { ?>
			<div class="overflow-carousel clearfix">
     			<!-- Carousel nav -->
     			<a class="next-button" href="#myCarousel<?php echo $id.'-'.$s; ?>" id="myCarousel<?php echo $id.'-'.$s; ?>_next"><i class="fa fa-angle-right"></i></a>
     			<a class="prev-button" href="#myCarousel<?php echo $id.'-'.$s; ?>" id="myCarousel<?php echo $id.'-'.$s; ?>_prev"><i class="fa fa-angle-left"></i></a>
     			<script type="text/javascript">
     			$(document).ready(function() {
     			  var owl<?php echo $id . '_' . $s; ?> = $(".filter-product #myCarousel<?php echo $id.'-'.$s; ?> .owl-carousel");
     				
     			  $("#myCarousel<?php echo $id.'-'.$s; ?>_next").click(function(){
     			      owl<?php echo $id . '_' . $s; ?>.trigger('next.owl.carousel');
     			      return false;
     			    })
     			  $("#myCarousel<?php echo $id.'-'.$s; ?>_prev").click(function(){
     			      owl<?php echo $id . '_' . $s; ?>.trigger('prev.owl.carousel');
     			      return false;
     			  });
...
<div class="box clearfix box-with-products <?php if($carousel != '0') { echo 'with-scroll';  } ?>">
  <?php if($carousel != 0) { ?>
  <!-- Carousel nav -->
