...
<div id="mfilter-content-container">
  ...
  if($theme_options->get( 'product_per_pow2' ) == 6) { $class = 'six'; }
  if($theme_options->get( 'product_per_pow2' ) == 5) { $class = 'five'; }
  if($theme_options->get( 'product_per_pow2' ) == 3) { $class = 'three'; }
  if($theme_options->get( 'product_per_pow2' ) == 2) { $class = 'two'; }
