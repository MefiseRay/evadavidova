			      ...
			      <div class="row">
						...
						<div class=" image-additional thumbnails thumbnails-left clearfix">
							<ul>
						      ...
						      <li class="image-option-<?php echo $image['product_option_id']; ?>-<?php echo $image['product_option_value_id']; ?>" style="<?php echo (!$image['default_value'] ? 'display:none' : '' ); ?>"><div class='item'><a href="<?php echo $image['popup']; ?>" class="popup-image"  data-class="image-<?php echo $i++; ?>" data-image="<?php echo $image['popup']; ?>" data-zoom-image="<?php echo $image['popup']; ?>"><img 
