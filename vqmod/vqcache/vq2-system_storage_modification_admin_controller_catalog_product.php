...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
      ...
      $data['ro_installed'] 										= $this->model_module_related_options->installed();
		...
		$data['text_copy_value'] = $this->language->get('text_copy_value');
		$data['text_new_preset'] = $this->language->get('text_new_preset');
		$data['text_new_preset_error'] = $this->language->get('text_new_preset_error');
		...
		$data['text_attemplates'] = $this->language->get('text_attemplates');
		$data['text_attemplate_add'] = $this->language->get('text_attemplate_add');
		$data['text_attemplate_replace'] = $this->language->get('text_attemplate_replace');
		$data['text_attemplate_default'] = $this->language->get('text_attemplate_default');
		$data['text_add_attemplate'] = $this->language->get('text_add_attemplate');
		$data['text_save_attemplate'] = $this->language->get('text_save_attemplate');
		$data['text_new_attemplate_name'] = $this->language->get('text_new_attemplate_name');
		
		$data['help_attemplate_add'] = $this->language->get('help_attemplate_add');
		$data['help_attemplate_replace'] = $this->language->get('help_attemplate_replace');
		$data['help_attemplate_default'] = $this->language->get('help_attemplate_default');
		$data['help_save_attemplate'] = $this->language->get('help_save_attemplate');
		...
		if ($this->config->get('atpresets_installed')==1) {
			...
			$data['attemplates'] = $this->model_catalog_attemplate->getAttemplates(array('status'=>'1'));
...
// << Related Options / Связанные опции 
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
		...
		foreach ($product_attributes as $product_attribute) {
			...
			if ($attribute_info) {
				$data['product_attributes'][] = array(
					...
					'preset_id'                  => $preset_id,
					'allow_multiple'             => count($preset_id)>1 && $data['atpresets_allow_multiple'],
		...
		foreach ($product_options as $product_option) {
			...
			if (isset($product_option['product_option_value'])) {
				foreach ($product_option['product_option_value'] as $product_option_value) {
                    ...
                    if (is_file(DIR_IMAGE . $product_option_value['thumb'])) {
                        $image = $product_option_value['thumb'];
      ...
      // >> Product Option Image PRO module
                        ...
                        'default_value'           => $product_option_value['default_value'],
					);
				}
			}
